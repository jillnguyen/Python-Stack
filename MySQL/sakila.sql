...
SELECT customer.first_name, customer.last_name, customer.email, address.address, address.district, address.city_id
FROM customer 
...
FROM film WHERE film.rating = "G" AND film.special_features LIKE '%behind the scene%';    
...
SELECT actor.actor_id, actor.first_name, actor.last_name, film.title, film.description, film.release_year, film.special_features, category.name
FROM actor
